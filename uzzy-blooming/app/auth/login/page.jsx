...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-6 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] pt-24">
      ...
      <div className="w-full max-w-lg animate-floatIn">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-white p-12 shadow-3xl border border-gray-100 flex flex-col items-center">
          ...
          <div className="mb-12 text-center flex flex-col items-center gap-4">
            ...
            <h1 className="font-[var(--font-heading)] text-5xl font-black tracking-tight text-primary leading-none">SIGN IN.</h1>
            <p className="mt-4 text-muted/60 font-light text-sm max-w-[240px]">
               Welcome back to your curated sanctuary of premium lifestyle.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="w-full space-y-6">
            ...
            <div className="space-y-2 group">
              <label htmlFor="login-email" className="text-[10px] uppercase font-black tracking-widest text-muted/60 px-6 block group-focus-within:text-primary transition-colors">
                 Email Address
              </label>
              <input
                id="login-email"
            ...
            <div className="space-y-2 group">
              <div className="flex justify-between items-center px-6">
                <label htmlFor="login-password" className="text-[10px] uppercase font-black tracking-widest text-muted/60 group-focus-within:text-primary transition-colors">
                   Password
                </label>
                <Link href="#" className="text-[9px] uppercase font-bold text-accent tracking-widest hover:underline decoration-accent/30 underline-offset-4">
                   Forgot?
                </Link>
              </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-[10px] uppercase font-black tracking-widest text-muted/40">
              New to the collecton?{" "}
              <Link href="/auth/signup" className="text-secondary-foreground hover:text-primary underline decoration-accent/30 underline-offset-8 decoration-2 transition-all">
                JOIN THE CLUB.
              </Link>
            </p>
          </div>
