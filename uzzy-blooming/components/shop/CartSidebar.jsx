                ...
                <div className="flex h-full flex-col">
                    ...
                    {items.length > 0 && (
                        <div className="border-t border-neutral-100 bg-neutral-50 p-5">
                            ...
                            <Link href="/checkout" onClick={closeSidebar} className="block w-full">
                                <Button className="w-full justify-center">Proceed to Checkout</Button>
                            </Link>
                            <div className="mt-3 text-center">
                                <Link href="/cart" onClick={closeSidebar} className="text-sm font-semibold text-primary/70 hover:text-primary underline decoration-transparent hover:decoration-current transition-all">
                                    View Datails
                                </Link>
                            </div>
                        </div>
