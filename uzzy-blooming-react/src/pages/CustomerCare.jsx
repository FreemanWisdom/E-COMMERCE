    ...
    return (
        <section className="container-padded section-space">
            <div className="mx-auto max-w-3xl space-y-6">
                ...
                <h1 className="text-3xl text-primary sm:text-4xl">Customer Care</h1>
                ...
                <div className="space-y-4 text-sm leading-7 text-primary/80">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <div className="rounded-2xl border border-neutral-100 bg-white p-5">
                            ...
                            <p className="mt-2 text-primary/80">support@uzzybloominghomes.com</p>
                            <p className="text-xs text-primary/60">Response within 24 hours</p>
                        </div>
                        <div className="rounded-2xl border border-neutral-100 bg-white p-5">
                            <h3 className="font-bold text-accent">Phone Support</h3>
                            <p className="mt-2 text-primary/80">+234 800 000 0000</p>
                    ...
                    <ul className="list-disc pl-5">
                        <li><Link to="/delivery-information" className="underline hover:text-accent">Delivery Information</Link></li>
                        <li><Link to="/returns-policy" className="underline hover:text-accent">Returns Policy</Link></li>
                        <li><Link to="/privacy-policy" className="underline hover:text-accent">Privacy Policy</Link></li>
                    </ul>
